...
Added Dark Mode to match system - 407 bytes
Fixed blank startup dirty flag - 2 bytes
Fixed startup editor focus - minus 7 bytes
Fixed Crinkler RAM 500MB with /HASHSIZE:8 - 98 bytes
