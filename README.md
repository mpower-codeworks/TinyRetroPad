...
```ascii
 ...
 |__   __(_)           |  __ \    | |           |  __ \        | |
    | |   _ _ __  _   _| |__) |___| |_ _ __ ___ | |__) |_ _  __| |
    | |  | | '_ \| | | |  _  // _ \ __| '__/ _ \|  ___/ _` |/ _` |
    | |  | | | | | |_| | | \ \  __/ |_| | | (_) | |  | (_| | (_| |
    |_|  |_|_| |_|\__, |_|  \_\___|\__|_|  \___/|_|   \__,_|\__,_|
        T I N Y    __/ |   X 86   D E S K T O P   E D I T O R                                     
                  |___/ 
```
...
## Newly added feature: Dark Mode Option
