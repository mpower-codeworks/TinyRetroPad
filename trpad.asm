...
HKEY_CURRENT_USER equ 80000001h ; registry hive for saved font
...
RegCreateNm db "RegCreateKeyExA",0  ; save font key
RegOpenNm   db "RegOpenKeyExA",0    ; load font key
RegQueryNm  db "RegQueryValueExA",0 ; load font value
RegSetNm    db "RegSetValueExA",0   ; save font value
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; find registry APIs for saved font setting    ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
MainEntry proc NEAR
    ...
    ; load saved font setting before any document is formatted
    ...
    ; put caret in editor so typing works immediately
    mov     eax, hEdit
    push    eax
    call    [_imp__SetFocus@4]
...
WndProc proc hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
    ...
    NotWMSize:
        ...
        ; user chose to continue, close main window
        push    hWnd
        call    [_imp__DestroyWindow@4]
